...
<div align="center">
  <h1><b>Hello Rails React</b></h1><a name="about-project"></a>
</div>
...
> This is a set-up Project that implements a connection between a Ruby on Rails back-end and React front-end.
...
```sh
  cd my-folder
  git clone https://github.com/Luiscarlosvd/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Luiscarlosvd/hello-rails-react/issues).
